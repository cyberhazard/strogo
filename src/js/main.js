...
(()=>{
  ...
  makeBlock('Oxford Brown Frannel And Tbrown Tweed', '25 000', '/images/models/oxfords_7 3', 'oxfords' , '')
  ...
  makeBlock('Single Monk Сalf Brown', '27 000', '/images/models/single_8 3', 'single' , '')
